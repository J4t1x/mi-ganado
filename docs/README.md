...
|-----------|-------------|-------------|
| [ARCHITECTURE.md](./ARCHITECTURE.md) | Arquitectura técnica, stack, modelo de datos, diagramas Mermaid | 2026-02-08 |
| [STATUS.md](./STATUS.md) | Estado actual de módulos, bugs activos, próximas prioridades | 2026-02-08 |
| [CONVENTIONS.md](./CONVENTIONS.md) | Patrones de código, naming, estructura de módulos CRUD | 2026-02-08 |
